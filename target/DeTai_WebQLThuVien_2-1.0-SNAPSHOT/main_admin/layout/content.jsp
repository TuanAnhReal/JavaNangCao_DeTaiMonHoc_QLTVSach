...
<section id="book-management" class="content-section d-none">
    ...
    <!-- Book List Table -->
    <div class="card p-4 shadow-sm overflow-auto" id="book-management-section">
        <table class="table table-hover table-striped" id="bookTable">
            <thead class="table-light">
                <tr>
                    ...
                    <th class="px-3 py-3 small text-muted text-uppercase">Tiêu Đề</th> <!-- THÊM TIÊU ĐỀ -->
                    <th class="px-3 py-3 small text-muted text-uppercase">Ngày Đăng</th>
                    <th class="px-3 py-3 small text-muted text-uppercase">Thể Loại</th>
                    <th class="px-3 py-3 small text-muted text-uppercase">Người Đăng</th>
                    <th class="px-3 py-3 small text-muted text-uppercase text-center">Giá Bán</th>
                    <th class="px-3 py-3 small text-muted text-uppercase text-center">Trạng Thái</th>
                    <th class="px-3 py-3 small text-muted text-uppercase text-center">Hành Động</th>
                </tr>
            </thead>
            <tbody id="bookTableBody" class="small">
                <tr><td colspan="7" class="text-center p-3 text-secondary">Đang tải dữ liệu sách...</td></tr>
            </tbody>
        </table>
...
<section id="category-management" class="content-section d-none">
    ...
    <div class="card p-4 shadow-sm overflow-auto">
        <table class="table table-hover table-striped" id="theLoaiTable">
            <thead class="table-light">
                <tr>
                    ...
                    <th class="px-3 py-3 small text-muted text-uppercase text-center">Số sách</th>
                    <th class="px-3 py-3 small text-muted text-uppercase text-center">Trạng Thái</th>
                    <th class="px-3 py-3 small text-muted text-uppercase text-center">Thao Tác</th>
                </tr>
            </thead>
            <tbody id="theLoaiTableBody" class="small">
...
<section id="user-management" class="content-section d-none">
    ...
    <div class="card p-4 shadow-sm overflow-auto">
        <table class="table table-hover table-striped" id="userTable">
            <thead class="table-light"> <!-- KHÔI PHỤC THEAD BỊ MẤT -->
                <tr>
                    <th class="px-3 py-3 small text-muted text-uppercase">ID</th>
                    <th class="px-3 py-3 small text-muted text-uppercase">Tên</th>
                    <th class="px-3 py-3 small text-muted text-uppercase">Email</th>
                    <th class="px-3 py-3 small text-muted text-uppercase">SĐT</th>
                    <th class="px-3 py-3 small text-muted text-uppercase">Số Dư (Tiền)</th>
                    <th class="px-3 py-3 small text-muted text-uppercase text-center">Hành động</th>
                </tr>
            </thead>
